	...
	<div class="container">
		<div class="bg0 flex-wr-sb-c p-rl-20 p-tb-8">
			<div class="f2-s-1 p-r-30 m-tb-6">
				...
				<a href="category-02" class="breadcrumb-item f1-s-3 cl9">
					Category
				</a>
		...
		<div class="container">
			<div class="row m-rl--1">
				<div class="col-md-6 p-rl-1 p-b-2">
					<div class="bg-img1 size-a-3 how1 pos-relative" style="background-image: url(images/B2.jpg);">
						...
						<div class="flex-col-e-s s-full p-rl-25 p-tb-20">
							...
							<h3 class="how1-child2 m-t-14 m-b-10">
								...
								NHỮNG CÁ NHÂN NỔI BẬT CỦA BÓNG ĐÁ VIỆT NAM 2024
								</a>
							</h3>
				...
				<div class="col-md-6 p-rl-1">
					<div class="row m-rl--1">
						<div class="col-sm-6 p-rl-1 p-b-2">
							<div class="bg-img1 size-a-14 how1 pos-relative" style="background-image: url(images/B1.jpg);">
								<a href="blog-detail-01" class="dis-block how1-child1 trans-03"></a>
						...
						<div class="col-sm-6 p-rl-1 p-b-2">
							<div class="bg-img1 size-a-14 how1 pos-relative" style="background-image: url(images/B6.jpg);">
								<a href="blog-detail-01" class="dis-block how1-child1 trans-03"></a>
								...
								<div class="flex-col-e-s s-full p-rl-25 p-tb-20">
									...
									<h3 class="how1-child2 m-t-14">
										<a href="blog-detail-01" class="how-txt1 size-h-1 f1-m-1 cl0 hov-cl10 trans-03">
										Tin bão mới nhất: Khả năng cao bão số 4 sẽ đổ bộ vào miền Trung dẫu hướng di chuyển khá phức
										</a>
									</h3>
								</div>
							</div>
						...
						<div class="col-sm-6 p-rl-1 p-b-2">
							<div class="bg-img1 size-a-14 how1 pos-relative" style="background-image: url(images/B7.jpg);">
								<a href="blog-detail-01" class="dis-block how1-child1 trans-03"></a>
						...
						<div class="col-sm-6 p-rl-1 p-b-2">
							<div class="bg-img1 size-a-14 how1 pos-relative" style="background-image: url(images/B11.jpg);">
								<a href="blog-detail-01" class="dis-block how1-child1 trans-03"></a>
								...
								<div class="flex-col-e-s s-full p-rl-25 p-tb-20">
									...
									<h3 class="how1-child2 m-t-14">
										<a href="blog-detail-01" class="how-txt1 size-h-1 f1-m-1 cl0 hov-cl10 trans-03">
										Kinh tế thế giới | Biến động chính sách tiền tệ của Mỹ tháng 7
										</a>
									</h3>
								</div>
							</div>
				...
				<div class="col-md-10 col-lg-8 p-b-80">
					<div class="row">
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								...
								<div class="p-t-16">
									<h5 class="p-b-5">
										<a href="blog-detail-01" class="f1-m-3 cl2 hov-cl10 trans-03">
										Không khí chào đón Tết Ất Tỵ 2025 tràn ngập khắp cả nước 
										</a>
									</h5>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01" class="wrap-pic-w hov1 trans-03">
									<img src="images/B4.jpg" alt="IMG">
								</a>

								<div class="p-t-16">
									<h5 class="p-b-5">
										<a href="blog-detail-01" class="f1-m-3 cl2 hov-cl10 trans-03">
										Cúm bùng phát ở nhiều quốc gia, cảnh báo nghiêm trọng tại Việt Nam 
										</a>
									</h5>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01" class="wrap-pic-w hov1 trans-03">
									<img src="images/B5.jpg" alt="IMG">
								</a>

								<div class="p-t-16">
									<h5 class="p-b-5">
										<a href="blog-detail-01" class="f1-m-3 cl2 hov-cl10 trans-03">
										Đổi viện trợ lấy hòa bình: Hàn Quốc có tạo được đột phá?
										</a>
									</h5>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01" class="wrap-pic-w hov1 trans-03">
									<img src="images/B8.jpg" alt="IMG">
								</a>

								<div class="p-t-16">
									<h5 class="p-b-5">
										<a href="blog-detail-01" class="f1-m-3 cl2 hov-cl10 trans-03">
										Phê bình âm nhạc và mong muốn của người làm nghề
										</a>
									</h5>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								...
								<div class="p-t-16">
									<h5 class="p-b-5">
										<a href="blog-detail-01" class="f1-m-3 cl2 hov-cl10 trans-03">
										Ngày 3-11/8, thi âm nhạc quốc tế violin và hòa tấu thính phòng
										</a>
									</h5>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01" class="wrap-pic-w hov1 trans-03">
									<img src="images/B10.jpg" alt="IMG">
								</a>

								<div class="p-t-16">
									<h5 class="p-b-5">
										<a href="blog-detail-01" class="f1-m-3 cl2 hov-cl10 trans-03">
										Áp lực lớn, tỷ giá vẫn khó biến động mạnh - Tạp chí Tài chính 
										</a>
									</h5>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01" class="wrap-pic-w hov1 trans-03">
									<img src="images/B11.jpg" alt="IMG">
								</a>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01" class="wrap-pic-w hov1 trans-03">
									<img src="images/B12.jpg" alt="IMG">
								</a>

								<div class="p-t-16">
									<h5 class="p-b-5">
										<a href="blog-detail-01" class="f1-m-3 cl2 hov-cl10 trans-03">
										24 hình thức lừa đảo phổ biến trên không gian mạng Việt Nam -
										</a>
									</h5>
...
Hãy đồng hành cùng chúng tôi để không bỏ lỡ bất kỳ thông tin nào!							</p>
