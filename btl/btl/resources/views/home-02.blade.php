			...
			<div class="row m-rl-0 justify-content-center">
				<div class="col-md-4 p-rl-1 p-b-2">
					<div class="bg-img1 size-a-11 how1 pos-relative" style="background-image: url(images/post-01.jpg);">
						<a href="blog-detail-02" class="dis-block how1-child1 trans-03"></a>
						...
						<div class="flex-col-e-s s-full p-rl-25 p-tb-18">
							...
							<h3 class="how1-child2 m-t-14 m-b-10">
								<a href="blog-detail-02" class="f1-l-1 cl0 hov-cl10 trans-03 respon1">
									Microsoft quisque at ipsum vel orci eleifend ultrices
								</a>
							</h3>
						</div>
						...
						<div class="p-b-25">
							...
							<div class="flex-wr-sb-s p-t-35">
								<div class="size-w-6 w-full-sr575">
									<!-- Item post -->	
									<div class="m-b-30">
										<a href="blog-detail-02" class="wrap-pic-w hov1 trans-03">
											<img src="images/post-21.jpg" alt="IMG">
										</a>

										<div class="p-t-25">
											<h5 class="p-b-5">
												<a href="blog-detail-02" class="f1-m-3 cl2 hov-cl10 trans-03">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<!-- Modal Video 01-->
	<div class="modal fade" id="modal-video-01" tab/="-1" role="dialog" aria-hidden="true">
