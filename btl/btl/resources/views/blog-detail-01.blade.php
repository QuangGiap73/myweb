	...
	<div class="container">
		<div class="headline bg0 flex-wr-sb-c p-rl-20 p-tb-8">
			<div class="f2-s-1 p-r-30 m-tb-6">
				...
				<a href="blog-list-01" class="breadcrumb-item f1-s-3 cl9">
					Blog 
				</a>
					...
					<div class="p-r-10 p-r-0-sr991">
						...
						<div class="p-b-70">
							...
							<h3 class="f1-l-3 cl2 p-b-16 p-t-33 respon2">
								Tổng thống Trump nhậm chức và tuyên bố rằng đã làm chủ thế giới
							</h3>
							...
							Donald Trump chính thức nhậm chức Tổng thống thứ 45 của Hoa Kỳ vào ngày 20 tháng 1 năm 2017, sau khi giành chiến thắng trước Hillary Clinton trong cuộc bầu cử tổng thống năm 2016. Buổi lễ nhậm chức diễn ra tại Điện Capitol, Washington, D.C., với sự tham dự của nhiều quan chức cấp cao, các cựu tổng thống, và đông đảo người dân.							</p>

							<p class="f1-s-11 cl6 p-b-25">
							Trong bài phát biểu nhậm chức, Trump nhấn mạnh thông điệp "Nước Mỹ trên hết" (America First), cam kết khôi phục nền kinh tế, siết chặt nhập cư và tái định hình chính sách đối ngoại của Hoa Kỳ. Lễ nhậm chức của ông cũng gây nhiều tranh cãi về quy mô đám đông tham dự và các cuộc biểu tình phản đối trên khắp nước Mỹ.							</p>

							<p class="f1-s-11 cl6 p-b-25">
							Nhiệm kỳ của Trump sau đó có nhiều chính sách gây tranh cãi, bao gồm cải cách thuế, chính sách nhập cư cứng rắn, và mối quan hệ căng thẳng với báo chí. Dù vậy, ông vẫn giữ được sự ủng hộ mạnh mẽ từ một bộ phận cử tri Mỹ.							</p>
