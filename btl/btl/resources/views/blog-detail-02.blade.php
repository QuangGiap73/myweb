...
<body class="animsition">
	...
	<section class="bg0 p-b-70 p-t-5">
		<!-- Title -->
		<div class="bg-img1 size-a-18 how-overlay1" style="background-image: url(images/A1.jpg);">
			<div class="container h-full flex-col-e-c p-b-58">
				...
				<h3 class="f1-l-5 cl0 p-b-16 txt-center respon2">
					Tổng thống Trump lên nhậm chức và tuyên bố rằng cả thế giới đã thuộc về mình
				</h3>
        ...
        <h1>{{ $post->name }}</h1>
        @if ($post->img)
            <img src="{{ asset('storage/' . $post->img) }}" class="img-fluid my-3" alt="{{ $post->name }}">
        @endif
