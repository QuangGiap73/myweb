				...
				<div class="col-md-10 col-lg-8 p-b-20">
					...
					<div class="row p-t-35">
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								...
								<div class="p-t-16">
									<h5 class="p-b-5">
										<a href="blog-detail-01" class="f1-m-3 cl2 hov-cl10 trans-03">
											Bitcoin đang biến động trên thị trường
										</a>
									</h5>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01" class="wrap-pic-w hov1 trans-03">
									<img src="images/A9.jpg" alt="IMG">
								</a>

								<div class="p-t-16">
									<h5 class="p-b-5">
										<a href="blog-detail-01" class="f1-m-3 cl2 hov-cl10 trans-03">
											Danh sách 31 cầu thủ Việt Nam
										</a>
									</h5>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01" class="wrap-pic-w hov1 trans-03">
									<img src="images/A10.jpg" alt="IMG">
								</a>

								<div class="p-t-16">
									<h5 class="p-b-5">
										<a href="blog-detail-01" class="f1-m-3 cl2 hov-cl10 trans-03">
											Top những điểm du lịch tại Việt Nam
										</a>
									</h5>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								...
								<div class="p-t-16">
									<h5 class="p-b-5">
										<a href="blog-detail-01" class="f1-m-3 cl2 hov-cl10 trans-03">
											Việt Nam lọt top10 địa điểm nhất định phải ghé thăm ở Đông Nam Á
										</a>
									</h5>
