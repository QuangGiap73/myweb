...
<html lang="en">
<head>
	<title>Blog List Sidebar v2</title>
	<meta charset="UTF-8">
				...
				<ul class="main-menu-m">
					<li>
						...
						<ul class="sub-menu-m">
							...
							<li><a href="home-2">Homepage v2</a></li>
							<li><a href="home-3">Homepage v3</a></li>
						</ul>
					...
					<div class="p-r-10 p-r-0-sr991">
						<div class="m-t--65 p-b-40">
							...
							<div class="flex-col-s-c how-bor2 p-t-65 p-b-40">
								...
								<a href="blog-detail-01" class="wrap-pic-w hov1 trans-03 m-b-30">
